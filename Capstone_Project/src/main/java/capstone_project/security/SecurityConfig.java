...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,  "/api/person","/api/person/*","/api/business","/api/business/*","/api/location","/api/location/*","/api/review","/api/review/*","/api/event","/api/event/*","/api/business/search/*","/api/person/search/*").permitAll()
